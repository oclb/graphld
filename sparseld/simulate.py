...
class Simulate:
    ...
    def simulate(self, precision_ops: List[PrecisionOperator]) -> List[pl.DataFrame]:
        ...
        for block_idx, op in enumerate(precision_ops):
        ...
        for block_idx, (op, indices, beta) in enumerate(zip(precision_ops, all_indices, all_betas)):
